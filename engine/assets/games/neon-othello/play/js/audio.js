/* Neon Othello — procedural WebAudio engine (all sounds synthesized, zero assets) */
'use strict';

const Sound = (() => {
  let ctx = null, master = null, musicGain = null, sfxGain = null, muted = false;
  const SET_KEY = 'np_ot_settings'; // {sound:true, level:'medium'} — shared with game.js
  ...
  const sfx = {
    ...
    place()  { tone(320, 210, 0.09, 'triangle', 0.22); noise(0.05, 0.08, 700, 1); },  // drop a disc
    flip(i = 0) { tone(420 + i * 70, 620 + i * 70, 0.07, 'sine', 0.12, i * 0.055); }, // cascade of flips
    pass()   { tone(300, 240, 0.16, 'sine', 0.16); tone(240, 190, 0.2, 'sine', 0.14, 0.16); },
    ...
    tick()   { tone(760, 760, 0.03, 'square', 0.08); },
  };
