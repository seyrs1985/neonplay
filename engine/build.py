...
def build_hall(cfg, gms):
    ...
    CATS = [
        ("arcade", "🎮 Arcade & Action", "🎮 街机动作",
         ["neon-tide", "snake", "flappy-dash", "breakout", "brickstorm", "neon-pop", "reflex-rush", "neon-hoops", "neon-air-hockey", "neon-beats", "bubble-storm", "rooftop-rush", "neon-typing", "neon-worms", "neon-runner"]),
        ("puzzle", "🧩 Puzzle & Brain", "🧩 益智解谜",
         ["2048", "minesweeper", "memory-pairs", "neon-block-jam", "neon-block-blast", "neon-nonogram", "neon-solitaire", "neon-fairway", "neon-link", "tile-rush", "neon-pyramid", "neon-mahjong", "neon-doodle", "neon-stack", "neon-blackjack"]),
        ("logic", "🐝 Word & Logic", "🐝 词与逻辑",
         ["word-hive", "neon-alchemy", "tic-tac-toe", "connect-four", "neon-checkers", "neon-wordle", "neon-othello"]),
