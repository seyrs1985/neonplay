...
- 2026-09-15-0331 · 新增游戏轮(夜班Ops代驱,自选加餐):第32款 Neon Checkers 上线——严格英式跳棋(强制吃子/极大连跳/加冕即停/封锁灭子判负,qa_tests四类规则断言)+AI三档(贪心/3层/迭代加深5层,节点+时间双保险丝,最难单步17ms)+2P同屏+每日挑战(UTC哈希档位种子)+霓虹手感(合法步高亮/吃子粒子/加冕特效);L={en,zh};QA桌面+touch双PASS;线上200;平衡块提取器首次实战(import断言32零重复)。
- 2026-09-15-0341 · 新增游戏轮(夜班Ops代驱,自选加餐):第33款 Neon Wordle 上线——每日五字母(UTC哈希全球同词)+无限模式+812答案/1807合法猜测压缩嵌入+重复字母反馈12组断言(blobb/abbey/erode边界)+硬模式+🔥streak月度补签+emoji方格分享+canvas卡+虚拟/实体双键盘;L={en,zh};QA桌面+touch双PASS;线上200。
- 2026-09-15-0440 · 新增游戏轮(夜班Ops代驱,终波双发):第34款 Neon Othello(黑白棋:8向射线翻子全断言/自动pass/终局计子56:6/AI三层级α-β+角权重最差112ms/每日挑战/2P同屏/七段位)与第35款 Neon Hangman(六分类360词各带提示句/Daily UTC同词跨分类轮换/6错SVG绞架逐笔走笔/猜中彩带+streak补签/重试同词不计绩)上线;QA四跑全PASS;期间games.py提取器两次失误(同行{兜底/ast法终成正果,已固化手法=ast.unparse提取条目),deploy在4/6 API检查瞬断一次由手工push+kick+IndexNow补完;线上双200;**夜班游戏总数18→35**;designs/done归档×2。
- 2026-09-15-0509 · 新增游戏轮(夜班收官):第36款 Neon Typing 上线——60秒打字街机(1747词3档词库/连击×2@5×3@12/3命警戒/七档段位/每日UTC同文/WPM准确率成绩卡/typing-speed-test变体页);QA抓出修复3真bug(M/P吞字母/maxTouchPoints误判/daily打卡);QA桌面+touch双PASS(12组断言);**同时修复存量bug:rooftop-rush自02:55起漏挂大厅CATS**(当时集成链中断被跳过),现补入;线上200;夜班游戏总数定格36;designs/done归档。
- 2026-09-19-1054 · 队列消化轮(dev):第37-40款 neon-stack / neon-worms / neon-runner / neon-blackjack 一次四连上线,清空 pending 队尾 4 份策划方案——①Neon Stack:落块消行(7-bag/简化SRS踢墙/锁定延迟0.5s/经典计分100-800×等级)+马拉松/冲刺40/每日种子三模式+移动端四手势(滑移/点按旋转/下滑软降/快甩硬降);②Neon Worms:slither式单机竞技场(37条AI蠕虫行为分层=游荡/觅食/围猎/逃逸+避障射线/4000²竞技场/冲刺烧长度/遗体爆光点/七段位)+每日种子食物图;③Neon Runner:跳蹲双动作跑酷(可变跳高/俯蹲hitbox减半/无人机34-46px高度带保证站撞蹲过/每500m速度档+全屏脉冲/间隙包络公式minGap=v×(airtime+0.42))+每日种子赛道;④Neon Blackjack:策略教练21点(6副牌S17/庄家peek/BJ赔3:2/硬牌软牌基本策略表14处断言/每步实时提示+人话理由/破产补助/每日20手同题牌靴/仅娱乐筹码合规)。四款全带?autotest=1自检套件+__qaState钩子+qa_tests专属脚本;QA桌面+touch八跑全PASS;线上待复验;designs/done归档×4。
